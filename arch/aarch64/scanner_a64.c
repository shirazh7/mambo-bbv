...
void a64_branch_helper(uint32_t *write_p, uint64_t target, bool link)
{
  ...
  assert(((difference & 3) == 0) && (difference < 128 * 1024 * 1024 && difference >= -128 * 1024 * 1024));
...
{
  int64_t difference = target - (uint64_t)write_p;
  assert(((difference & 3) == 0) && (difference < 1024 * 1024 && difference >= -1024 * 1024));
...
{
  int64_t difference = target - (uint64_t)write_p;
  assert(((difference & 3) == 0) && (difference < 32 * 1024 && difference >= -32 * 1024));
